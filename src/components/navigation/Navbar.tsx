...
const Navbar = (props: NavbarProps) => {
  ...
  return (
    <nav className={`fixed z-50 inset-x-0 top-0 w-full h-fit bg-primary-500 transition-fast ${lastScrollY === 0 ? 'lg:bg-primary-500' : isVisible ? 'lg:bg-primary-500/60 lg:hover:bg-primary-500' : 'lg:bg-primary-500/0 lg:-translate-y-full lg:pointer-events-none'}`}>
